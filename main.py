...
class Mamba:
    ...
    def send_messages(self):
        """
        TODO:
            1. Открыть аккаунт пользователя (не нужно)
            2. Найти кнопку сообщения (не нужно)
            3. Зайти туда (не нужно)
            4. Отправить "Привет :3" (на проверке)
            5. Записать в список отправленных сообщений
        """
